 ...
 *
 * Copy this HAL and implement following
 * macros in your device tree
 *
 *  NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE
 */
#define CHARGE_CONTROL_NODE "<YOUR NODE>"
#define CHARGE_ENABLED '<YOUR VALUE>'
#define CHARGE_DISABLED '<YOUR VALUE>'
